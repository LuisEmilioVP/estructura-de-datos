...
public class EjerciciosMatrices {
   ...
   * productoEscalar += vector1[i] * vector2[i]; // Asignacion y multiplicacion de
   * los vectores
   * }
   * 
   ...
   * 
   * /*
   * Declaración de dos ciclos una para iterar por las filas de la matriz y ek
   * otro para que muestre las furtas deacuerdoa su posicion en la matriz.
